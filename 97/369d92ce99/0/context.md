...
commands are not the same as skills

https://www....

### Prompt 38

should our mcp tools be exposed as skills?

### Prompt 39

havent used it yet. create follow up github issue

### Prompt 40

"Clean. Renamed BRAIN_SKILLS → BRAIN_COMMANDS and setupSkills → setupCommands throughout. Commands are slash commands (.claude/commands/), not auto-invoked skills (.claude/skills/)" - commit and push
