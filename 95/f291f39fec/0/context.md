...
remove the deprecated code in @app/src/server/extraction/identity-resolution.ts  and create a gh issue to fix the failing identity non-related tests

### Prompt 7

commit @schema/migrations/0018_edge_migration_identity.surql
