...
whats left from the "IAM: Unified Auth Layer Implementation Plan" to implement
...
whats left in the @docs/plans/iam.md plan to implement?

### Prompt 20

split the file up into phases
...
can do: docs/plans/iam/README.md
docs/plans/iam/phase-1 etc
